"""
validate_manual_annotations.py

Purpose:
    - Validate the integrity and consistency of manually annotated data
      prior to dataset splitting and model training.
...
# Load Data
# -------------------------
df = pd.read_csv("data/extraction/sampling/annotation_sample_labeled.csv")
